...
## Optional section if kids feel like they want more guidance
Does anyone have any questions? (if so answer (probbaly)) if not) Alright, if anything comes up, feel free to code ask any of the mentors in the "somecolor" shirts for help.

Who wants to go through some more stuff together? All the rest can be found in the getting-started section, and mentors will be avaliable to help anyone that needs it, Show of hands?

### Put more optional demo stuff here
